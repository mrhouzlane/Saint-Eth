...
contract SaintEth is Ownable, VRFConsumerBaseV2 {
    ...
    // fulfillrandomNumbers() function. Storing each word costs about 20,000 gas,
    ...
    // Retrieve one number for the winnerId.
    ...
    function requestrandomNumbers() external onlyOwner {
        ...
        s_requestId = COORDINATOR.requestrandomNumbers(
        keyHash,
        s_subscriptionId,
